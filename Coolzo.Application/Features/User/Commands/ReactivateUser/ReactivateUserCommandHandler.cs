...
public sealed class ReactivateUserCommandHandler : IRequestHandler<ReactivateUserCommand, UserResponse>
{
    ...
    public async Task<UserResponse> Handle(ReactivateUserCommand request, CancellationToken cancellationToken)
    {
        ...
        var actorName = ResolveActorName("ReactivateUser");
        ...
        await _auditLogRepository.AddAsync(
            new AuditLog
            {
                ...
                StatusName = "Success",
                NewValues = "User account reactivated.",
                CreatedBy = actorName,
